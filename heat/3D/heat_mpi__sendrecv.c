...
int main ( int argc, char** argv )
{
  ...
  for (n=0; n<N; n++) {
    ...
    MPI_Sendrecv(&u[s_send], I*J, MPI_DOUBLE, ip_lo, 0,
                 &u[s_recv], I*J, MPI_DOUBLE, ip_lo, 0,
    ...
    MPI_Sendrecv(&u[s_send], I*J, MPI_DOUBLE, ip_hi, 0,
                 &u[s_recv], I*J, MPI_DOUBLE, ip_hi, 0,
                 MPI_COMM_WORLD, &status);
